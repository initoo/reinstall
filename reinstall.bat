...
set confhome=https://raw.githubusercontent.com/initoo/reinstall/main
set confhome_cn=https://cnb.cool/initoo/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/initoo/reinstall/main
