...
set -eE
confhome=https://raw.githubusercontent.com/initoo/reinstall/main
confhome_cn=https://cnb.cool/initoo/reinstall/-/git/raw/main
...
Manual: https://github.com/initoo/reinstall
